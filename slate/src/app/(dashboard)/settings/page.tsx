...
export default function SettingsPage() {
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-[#1B1D24] mb-8">Settings</h1>

      <div className="space-y-8">
        {/* Profile */}
        <Card>
          <h2 className="text-base font-semibold text-[#1B1D24] mb-4">Profile</h2>
        ...
        {/* Data Retention */}
        <Card>
          <h2 className="text-base font-semibold text-[#1B1D24] mb-2">Data Retention</h2>
          <p className="text-sm text-[#767A85] mb-4">
            Control how long your uploaded PDFs are stored. Filled forms are available for download for this period.
          </p>
          <select className="h-10 px-3 rounded-xl border border-[#E2E4EA] bg-white text-sm text-[#1B1D24] w-48">
